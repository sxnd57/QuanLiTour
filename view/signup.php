        ...
        <div class="container text-center">
            <div class="form-section row h-100">
                ...
                <div class="col-md-7 d-flex align-items-center">
                    <form action="validationSignupForm.php" class="w-100 form-wrapper needs-validation" method="post">
                        ...
                        <div class="link-section d-flex align-items-center justify-content-between mx-5 my-4">
                            <div>
                                ...
                                <a href="./term.php" for="accpept-term" class="link-section accpept-term ps-3">Accept
                                    term & conditions</a>
                            </div>
